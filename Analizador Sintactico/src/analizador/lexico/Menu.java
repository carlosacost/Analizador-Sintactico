...
int vawhile=0,vafor=0,vai=0,vasu=0;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnlexico, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 510, -1, 30));
        ...
        getContentPane().add(btnsintactico, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 510, -1, -1));
